(function (f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f() } else if (typeof define === 'function' && define.amd) { define([], f) } else { let g; if (typeof window !== 'undefined') { g = window } else if (typeof global !== 'undefined') { g = global } else if (typeof self !== 'undefined') { g = self } else { g = this }g.XRegExp = f() } }(() => {
 ...
 */
    ...
    8: [function (require, module, exports) {
      ...
      './addons/build': 1, './addons/matchrecursive': 2, './addons/unicode-base': 3, './addons/unicode-blocks': 4, './addons/unicode-categories': 5, './addons/unicode-properties': 6, './addons/unicode-scripts': 7, './xregexp': 9
    }],
 ...
 */
      function isPatternNext (pattern, pos, flags, needlePattern) {
        ...
        const patternsToIgnore = flags.indexOf('x') > -1
