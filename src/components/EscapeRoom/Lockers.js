  ...
  render () {
    return (
      <>
        ...
        {!this.props.matches && <img src="#" alt="matches" onClick={this.onClick} />}
        {!this.props.wrench && <img src="#" alt="wrench" onClick={this.onClick} />}
        {!this.props.usb && <img src="#" alt="usb" onClick={this.onClick} />}
        {!this.props.soup && <img src="#" alt="soup" onClick={this.onClick} />}
        {!this.props.knife && <img src="#" alt="knife" onClick={this.onClick} />}
        {!this.props.paperclip && <img src="#" alt="paperclip" onClick={this.onClick} />}
      </>
    )
  }
}
